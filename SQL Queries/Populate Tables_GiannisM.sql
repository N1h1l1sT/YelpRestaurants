...
FROM 'C:\Users\GiannisM\Dropbox\AUTH\Lectures\5. Advanced Machine Learning\Paper 1 Yelp Restaurant Photo Classification\Data\train_photo_to_biz_ids.csv'
WITH 
	(
		FIRSTROW = 2,
		FIELDTERMINATOR = ',',
...
BULK INSERT #TempTable
FROM 'C:\Users\GiannisM\Dropbox\AUTH\Lectures\5. Advanced Machine Learning\Paper 1 Yelp Restaurant Photo Classification\Data\test_photo_to_biz.csv'
WITH 
	(
		FIRSTROW = 2,
		FIELDTERMINATOR = ',',
...
BULK INSERT #TempTable
FROM 'C:\Users\GiannisM\Dropbox\AUTH\Lectures\5. Advanced Machine Learning\Paper 1 Yelp Restaurant Photo Classification\Data\train.csv'
WITH (
		 FIRSTROW = 2,
		 FIELDTERMINATOR = ',',
		 ROWTERMINATOR = '\n'
